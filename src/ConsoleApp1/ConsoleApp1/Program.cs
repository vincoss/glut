...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            var a = 1.5;
            var t = a - Math.Truncate(a);

            Console.WriteLine(t);

            LinqGroupDateTimeSamples.SampleFour();
            ...
            //series.Add(new Sample() { Timestamp = date.AddSeconds(61.5), Value = 3 });
            ...
            //var gc = from s in series
            //         let res = s.Timestamp - date
            //         orderby s.Timestamp
